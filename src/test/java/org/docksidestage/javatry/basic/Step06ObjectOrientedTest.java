...
import org.docksidestage.bizfw.basic.buyticket.TicketOneDay;
...
public class Step06ObjectOrientedTest extends PlainTestCase {
    ...
    private void saveBuyingHistory(int quantity, Integer displayPrice, int salesProceeds, boolean alreadyIn) {
        if (alreadyIn) {
    ...
    public void test_objectOriented_aboutObject_usingObject() {
        ...
        // _/_/_/_/_/_/_/_/_/_/
        TicketOneDay ticket = booth.buyOneDayPassport(10000);
    ...
    private void saveBuyingHistory(TicketBooth booth, TicketOneDay ticket) {
    ...
    private void doShowYourTicket(TicketOneDay ticket) {
    ...
    public void test_objectOriented_writing_generalization_extractToAbstract() {
        ...
        log(mySql.buildPagingQuery(10, 5));
        log(postgreSql.buildPagingQuery(10, 5));
    }
    ...
    public void test_objectOriented_writing_specialization_extractToConcrete() {
        // your confirmation code here
        St6OperationSystem mac = new Mac("linh");
        St6OperationSystem windows = new Windows("linh");
        St6OperationSystem oldWin = new OldWindows("linh");
        log("Mac's format: {}", mac.buildUserResourcePath("myFolder"));
        log("Windows's format: {}", windows.buildUserResourcePath("myFolder"));
        log("Old windows's format: {}", oldWin.buildUserResourcePath("myFolder"));
        St6OperationSystem linux = new St6OperationSystem("Linux", "linh");
        log("Linux's format: {}", linux.buildUserResourcePath("myFolder"));
    }
